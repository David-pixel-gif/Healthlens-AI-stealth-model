// File: src/components/diseases/brain_tumor/Review.jsx
    ...
    <Container className="my-4">
      <Card className="p-4 shadow-sm border-0 rounded-4">
        <Row className="align-items-center">
          <Col>
            <h3 className="mb-0">🧠 Brain Tumor · Review</h3>
            <div className="text-muted">Diagnosis ID: {id}</div>
          </Col>
          <Col className="text-end">
            <Link to={`/diseases/brain_tumor/treat/${id}`}>
            ...
            {current ? (
                    ...
                    <Row className="g-3">
                      ...
                      <Col md={3}>
                        ...
                        <div className="fw-semibold text-capitalize">
                          {current.disease_key || "brain_tumor"}
                        </div>
                      </Col>
                      <Col md={3}>
              ...
              <>
                ...
                <Card className="mt-3 border-0 shadow-sm">
                  <Card.Body>
                    <h5 className="mb-3">Recent Brain Tumor Diagnoses</h5>
                    <RBTable hover responsive className="mb-0">
                      ...
                      <tbody>
                        {items
                          .filter((x) => x.disease_key === "brain_tumor")
                          .map((x) => (
                            <tr key={x.id}>
                              <td>{x.id}</td>
                              ...
                              <td>
                                <Link
                                  to={`/diseases/brain_tumor/review/${x.id}`}
                                >
