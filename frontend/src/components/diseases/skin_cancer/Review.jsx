// File: src/components/diseases/skin_cancer/Review.jsx
    ...
    <Container className="my-4">
      <Card className="p-4 shadow-sm border-0 rounded-4">
        <Row className="align-items-center">
          <Col>
            <h3 className="mb-0">🧴 Skin Cancer · Review</h3>
            <div className="text-muted">Diagnosis ID: {id}</div>
          </Col>
          <Col className="text-end">
            <Link to={`/diseases/skin_cancer/treat/${id}`}>
            ...
            {current ? (
                    ...
                    <Row className="g-3">
                      ...
                      <Col md={3}>
                        ...
                        <div className="fw-semibold text-capitalize">
                          {current.disease_key || "skin_cancer"}
                        </div>
                      </Col>
                      <Col md={3}>
              ...
              <>
                <Alert variant="warning" className="mt-4">
                  ...
                  the recent list. It may be older than your recent window or
                  not yet created.
                </Alert>

                <Card className="mt-3 border-0 shadow-sm">
                  <Card.Body>
                    <h5 className="mb-3">Recent Skin Cancer Diagnoses</h5>
                    <RBTable hover responsive className="mb-0">
                      ...
                      <tbody>
                        {items
                          .filter((x) => x.disease_key === "skin_cancer")
                          .map((x) => (
                            <tr key={x.id}>
                              <td>{x.id}</td>
                              ...
                              <td>
                                <Link
                                  to={`/diseases/skin_cancer/review/${x.id}`}
                                >
