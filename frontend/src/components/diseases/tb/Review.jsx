// File: src/components/diseases/tb/Review.jsx
    ...
    <Container className="my-4">
      <Card className="p-4 shadow-sm border-0 rounded-4">
        <Row className="align-items-center">
          <Col>
            <h3 className="mb-0">🧫 Tuberculosis · Review</h3>
            <div className="text-muted">Diagnosis ID: {id}</div>
          </Col>
          <Col className="text-end">
            <Link to={`/diseases/tb/treat/${id}`}>
            ...
            {current ? (
              ...
              <>
                ...
                <Card className="mt-3 border-0 shadow-sm">
                  <Card.Body>
                    <h5 className="mb-3">Recent TB Diagnoses</h5>
                        ...
                        {items
                          ...
                          .map((x) => (
                            <tr key={x.id}>
                              ...
                              <td>{x.created_at || "—"}</td>
                              <td>
                                <Link to={`/diseases/tb/review/${x.id}`}>
